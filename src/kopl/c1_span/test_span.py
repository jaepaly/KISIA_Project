...
def test_multi_channel_post() -> None:
    """다중 채널(글 전체) 탐지 및 span_id 일괄 부여 검증."""
...
if __name__ == "__main__":
    ...
    print("=== [성공] c1_span 골격의 모든 검증을 통과했습니다! ===")
