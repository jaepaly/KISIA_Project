...
- **둘 다 값 20칸 중 12칸은 입력에 그대로 적힌 나이·성별**(「40대 남성」→ 40대 / 남성)이라 추론이 아니다. 두 모델이 실제로 추론한 칸은 8칸(location 3 · occupation 3 · family 2)이고 그중 7칸이 일치했다. 0.95 는 이 8칸의 7/8 과 같이 읽어야 한다.
